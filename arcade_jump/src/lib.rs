...
/// Provide a simple trajectory data structure with a combination of the four parameters
...
/// "compute!" procedural macro to compute trajectory parameters with a simpler syntax
pub use arcade_jump_macros::compute;

// re-export elements

pub use resolver::error::{Error, ErrorTime};
pub use resolver::*;
